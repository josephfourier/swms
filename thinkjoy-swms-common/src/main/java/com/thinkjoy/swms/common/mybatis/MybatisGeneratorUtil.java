...
import com.thinkjoy.common.util.VelocityUtil;
...
import static com.thinkjoy.common.util.StringUtil.lineToHump;
...
public class MybatisGeneratorUtil {
    ...
    public static void generator(
        ...
        generatorConfig_vm = com.thinkjoy.swms.common.mybatis.MybatisGeneratorUtil.class.getResource(generatorConfig_vm).getPath();
        service_vm = com.thinkjoy.swms.common.mybatis.MybatisGeneratorUtil.class.getResource(service_vm).getPath();
        serviceMock_vm = com.thinkjoy.swms.common.mybatis.MybatisGeneratorUtil.class.getResource(serviceMock_vm).getPath();
        serviceImpl_vm = com.thinkjoy.swms.common.mybatis.MybatisGeneratorUtil.class.getResource(serviceImpl_vm).getPath();

        String targetProject = module + "/" + module + "-dao";
        String basePath = com.thinkjoy.swms.common.mybatis.MybatisGeneratorUtil.class.getResource("/").getPath().replace("/target/classes/", "").replace(targetProject, "");
        String generatorConfig_xml = com.thinkjoy.swms.common.mybatis.MybatisGeneratorUtil.class.getResource("/").getPath().replace("/target/classes/", "") + "/src/main/resources/generatorConfig.xml";
...
//      String sql = "SELECT table_name FROM INFORMATION_SCHEMA.TABLES WHERE table_schema = 'zjy' AND table_name in ('ams_approle')";
        ...
        try {
            ...
            // 查询定制前缀项目的所有表
            JdbcUtil jdbcUtil = new JdbcUtil(jdbc_driver, jdbc_url, jdbc_username, /*AESUtil.AESDecode(jdbc_password)*/jdbc_password);
            ...
            context.put("generator_javaModelGenerator_targetPackage", package_name + ".dao.entity");
            context.put("generator_sqlMapGenerator_targetPackage", package_name + ".rpc.mapper");
            ...
            context.put("generator_jdbc_password", /*AESUtil.AESDecode(jdbc_password)*/jdbc_password);
...
//        DefaultShellCallback callback = new DefaultShellCallback(false);// 是否覆盖
...
//        }
        ...
        String controllerPath = basePath + module + "/" + module + "-server" + "/src/main/java/" + package_name.replaceAll("\\.", "/") + "/server/controller";
