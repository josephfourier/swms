...
public class SwmsStudentHonorary implements Serializable {
    /**
     * 个人荣誉称号uid
     *
     * @mbg.generated
     */
    private String stuhonoraryUid;
    ...
    public String getStuhonoraryUid() {
        return stuhonoraryUid;
    }

    public void setStuhonoraryUid(String stuhonoraryUid) {
        this.stuhonoraryUid = stuhonoraryUid;
    }
    ...
    public String toString() {
        ...
        sb.append(", stuhonoraryUid=").append(stuhonoraryUid);
    ...
    public boolean equals(Object that) {
        ...
        SwmsStudentHonorary other = (SwmsStudentHonorary) that;
        return (this.getStuhonoraryUid() == null ? other.getStuhonoraryUid() == null : this.getStuhonoraryUid().equals(other.getStuhonoraryUid()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getStuhonoraryUid() == null) ? 0 : getStuhonoraryUid().hashCode());
