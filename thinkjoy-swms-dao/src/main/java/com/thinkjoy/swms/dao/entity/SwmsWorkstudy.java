...
public class SwmsWorkstudy implements Serializable {
    /**
     * 勤工助学uid
     *
     * @mbg.generated
     */
    private String workstudyUid;
    ...
    public String getWorkstudyUid() {
        return workstudyUid;
    }

    public void setWorkstudyUid(String workstudyUid) {
        this.workstudyUid = workstudyUid;
    }
    ...
    public String toString() {
        ...
        sb.append(", workstudyUid=").append(workstudyUid);
    ...
    public boolean equals(Object that) {
        ...
        SwmsWorkstudy other = (SwmsWorkstudy) that;
        return (this.getWorkstudyUid() == null ? other.getWorkstudyUid() == null : this.getWorkstudyUid().equals(other.getWorkstudyUid()))
            && (this.getWorksettingUid() == null ? other.getWorksettingUid() == null : this.getWorksettingUid().equals(other.getWorksettingUid()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getWorkstudyUid() == null) ? 0 : getWorkstudyUid().hashCode());
