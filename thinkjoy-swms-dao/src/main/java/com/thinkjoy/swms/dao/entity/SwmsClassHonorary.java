...
public class SwmsClassHonorary implements Serializable {
    /**
     * 班级荣誉称号uid
     *
     * @mbg.generated
     */
    private String clahonoraryUid;
    ...
    public String getClahonoraryUid() {
        return clahonoraryUid;
    }

    public void setClahonoraryUid(String clahonoraryUid) {
        this.clahonoraryUid = clahonoraryUid;
    }
    ...
    public String toString() {
        ...
        sb.append(", clahonoraryUid=").append(clahonoraryUid);
    ...
    public boolean equals(Object that) {
        ...
        SwmsClassHonorary other = (SwmsClassHonorary) that;
        return (this.getClahonoraryUid() == null ? other.getClahonoraryUid() == null : this.getClahonoraryUid().equals(other.getClahonoraryUid()))
    ...
    public int hashCode() {
        final int prime = 31;
        int result = 1;
        result = prime * result + ((getClahonoraryUid() == null) ? 0 : getClahonoraryUid().hashCode());
